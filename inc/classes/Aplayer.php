...
class Aplayer
{
    ...
    private function song_url($url){
        ...
        if ($server == 'netease') {
            ...
            $url = str_replace('http://m804.', 'https://m804.', $url);
            $url = str_replace('http://m701.', 'https://m701.', $url);
            $url = str_replace('http://m702.', 'https://m702.', $url);
            $url = str_replace('http://m703.', 'https://m703.', $url);
            $url = str_replace('http://m704.', 'https://m704.', $url);
        }elseif ($server == 'xiami') {
